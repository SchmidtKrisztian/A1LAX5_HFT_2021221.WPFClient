...
namespace MyLaptopShop.Repository.Interfaces
{
    ...
    public interface ISpecificationRepository : IRepository<Specification>
    {
        ...
        /// <param name="specification">String, the new CPU of a specification.</param>
        void ChangeCPU(int id, string specification);
        ...
        /// <param name="graphicscard">String, the new graphicscard of a specification.</param>
        void ChangeGraphicsCard(int id, string graphicscard);
